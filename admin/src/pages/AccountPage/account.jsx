...
export default function Account() {
  ...
  const goToCustomerPage = () => {
    // Bạn có thể xử lý logic ở đây trước khi đi
    navigate('/admin/editaccount/create'); // Chuyển đến đường dẫn /customers
  };
  return (
    <div className="container-fluid py-4 bg-light min-vh-100">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <div>
          <h3 className="fw-bold mb-0"> Tài khoản</h3>
          <nav aria-label="breadcrumb">
          </nav>
        </div>
        <div className="d-flex gap-2">
          <button onClick={goToCustomerPage} className="btn btn-primary btn-sm px-3 fw-bold shadow-sm">
        ...
        <div className="card-body p-0">
          ...
          <div className="d-flex justify-content-between align-items-center p-3 border-top bg-light rounded-bottom">
            ...
            <div className="small text-muted d-flex align-items-center gap-2">
              ...
              <span>items 1-3 of 3 items</span>
            </div>
          </div>
        </div>
      </div>
